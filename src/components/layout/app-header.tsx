...
export function AppHeader({ pageTitle, cartCount, onOpenSidebar }: AppHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 h-[var(--layout-header-height)] border-b border-app-border-light bg-transparent">
      <div className="flex h-full items-center gap-l px-6 mobile:px-10 desktop:px-[60px]">
        <button
          type="button"
        ...
        <h1 className="min-w-0 truncate font-display text-[30px] font-normal leading-none text-app-primary mobile:text-[34px] desktop:text-[36px]">
          {pageTitle}
        </h1>

        <form onSubmit={submitGlobalSearch} className="relative ml-auto w-full max-w-[300px]">
